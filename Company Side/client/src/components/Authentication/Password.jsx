...
const Password = () => {
  ...
  const sendPassword = () => {
    if (password == confirm) {
      ...
      fetch("http://localhost:7000/signup-password", {
        method: "POST",
        credentials: "include",
        headers: {
      ...
      <div className="mainCard">
        ...
        <div className="loginCard">
          ...
          <div className="entry-box">
            <Box>
              <TextField id="standard-basic" label="Enter Password" variant="filled" onChange={passwordSetter} sx={{ width: "25vw", marginBottom:"20px"}} />
            </Box>
            <p></p>
            <Box>
              <TextField id="standard-basic" label="Confirm Password" variant="filled" onChange={conifirmPassword} sx={{ width: "25vw" }} />
            </Box>
          </div>
